    ...
    return (
        <div>
            <div className="flex w-full relative">
                ...
                <div className="xl:text-6xl lg:text-5xl md:text-2xl sm:text-md z-10 text-center absolute inset-0 flex justify-center items-center text-[white] font-bold bg-[black] opacity-70">
                    {text}
                </div>
            </div>
        </div>
