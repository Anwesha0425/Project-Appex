      ...
      <main>
        <div className="relative h-screen overflow-hidden">
          <div className="absolute inset-0">
            <img
              ...
              alt="Empowering Community Image"
              className="object-cover w-screen h-screen opacity-70"
            />
          </div>

          <div className="relative z-10 flex flex-col justify-center items-center h-full text-center">
            <h1 className="text-white text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <header className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 mt-2">
                Build a Healthy and Favorable Socio Economic and Cultural
                Environment for an Egalitarian Society.
              </p>
            </header>

            {/* Story Section */}
            <section className="mb-12">
              <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-[#26aba2] text-center font-serif">
                Our Story
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Founded with a profound commitment to fostering positive social
                change, APPEX GUIDE LINE has been steadfastly working towards
                the holistic development of children and creating awareness
                about women&apos;s empowerment and gender issues. Since its
                inception, the organization has embarked on a journey of
                transformation, focusing on building knowledge and promoting
                self-development for socially backward and weaker sections of
                society. Over the years, APPEX GUIDE LINE has stood as a beacon
                of hope for the underprivileged and distressed, enabling them to
                achieve self-reliance and participate actively in their own
            ...
            {/* Mission Section */}
            <section className="mb-12">
              <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-center text-[#2561a5] font-serif">
                Our Mission
              </h2>
              <p className="text-gray-700 leading-relaxed">
                ...
                women&apos;s empowerment. By addressing the needs of
                marginalized communities, we strive to create opportunities for
            ...
            {/* Vision Section */}
            <section>
              <h2 className="text-3xl font-semibold text-gray-800 mb-4 text-center text-[#a22525] font-serif">
                Our Vision
              </h2>
              <p className="text-gray-700 leading-relaxed">
                We envision a society where every individual, regardless of
                their social or economic background, has the opportunity to live
                with dignity, self-reliance, and equal rights. Our goal is to
                create a robust framework for empowering the most vulnerable and
                marginalized, thereby contributing to a stronger and more
                inclusive nation. Through persistent efforts, innovative
                programs, and collective action, APPEX GUIDE LINE aspires to
                inspire transformative change that uplifts communities and
                fosters a brighter, equitable future for all.
              </p>
            </section>
          </div>
        </div>
        ...
        <div className="p-4">
          <div className="max-w-5xl mx-auto">
            ...
            <section className="mb-4 bg-white shadow-md rounded-lg p-6 text-[black] bg-[#f3fef5]">
              <h2 className="text-3xl font-semibold mb-4 font-serif text-center text-[#3aa023]">
              ...
              <ul className="text-gray-700 space-y-4">
                ...
                <li>
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      <strong>Registered Office:</strong> At/Po: Jhariapadar,
                      Via: Padmanavpur, Dist: Ganjam, Pin: 761007, Odisha,
                      India.
                    </li>
                    <li>
                    ...
                    <li>
                      <strong>Family Counselling Centre:</strong> Gandhi
                      Nagar-5th Line (East), Berhampur-1, Dist: Ganjam, Pin:
                      760003, Odisha, India.
                    </li>
                    <li>
                      <strong>
                ...
                <li>
                  ...
                  <ul className="ml-4 list-disc">
                    <li>
                      ...
                      1860 at Ganjam, No. GJM. 3661 of 1994-95, Dt. 23rd
                      November 1994.
                    </li>
                ...
                <li>
                  <strong>Main Area of Activity:</strong> Women Empowerment,
                  Child Development, Agricultural Promotion, Health, Rural
                  Development & Sanitation, Poverty Alleviation, Geriatric Care,
                  Global Warming, etc.
                </li>
                <li>
        ...
        <div className="p-4">
          <div className="max-w-6xl mx-auto">
            {/* Introduction */}
            <section className="bg-white shadow-md rounded-lg p-6 mb-4 text-[black] bg-[#fef3f3]">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center font-serif text-[#96213a]">
                Introduction
              </h2>
              <p className="text-gray-700">
                “APPEX GUIDE LINE” came into existence in 1991 as a
                village-level welfare organization born from the vision of
                prominent individuals renowned for their human values and
                experiences.
              </p>
              <p className="mt-4 text-gray-700">
                ...
                populations by revitalizing their economic lives and helping
                them realize their potential and capabilities.
              </p>
              <p className="mt-4 text-gray-700">
            ...
            {/* Operational Area */}
            <section className="bg-[#f8f4fc] shadow-md rounded-lg p-6 text-[black]">
              <h2 className="text-3xl font-bold text-gray-800 mb-4 text-center font-serif text-[#60229a]">
        ...
        <main className="min-h-screen">
          <section className="py-10 px-6 lg:px-20 ">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-3xl font-semibold text-gray-800 text-center font-serif text-[#1f9087]">
                Future Aspirations
              </h2>
              <ul className="mt-4 space-y-3 text-gray-600 list-disc list-inside ">
                ...
                <li>
                  Social development training programs in remote tribal
                  villages.
                </li>
                <li>
          ...
          <div className="min-h-screen p-6">
            <h1 className="text-3xl font-bold mb-6 text-center font-serif text-[#225a9a]">
              Annual Reports
            </h1>
            <div className="grid grid-cols-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 hover:shadow-2xl ">
          ...
          <div className="bg-gray-50 py-12">
            <div className="max-w-4xl mx-auto px-6 lg:px-8">
              <h2 className="text-3xl font-bold mb-6 text-center font-serif text-[#972222]">
                Acknowledgment
              </h2>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <span className="text-[#14144c] font-bold mr-2">1.</span>
                ...
                <li className="flex items-start">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Those staff and ex-staff whose efforts fortified the
                    attempts of the organization to be perfect.
                  </p>
                </li>
                <li className="flex items-start">
